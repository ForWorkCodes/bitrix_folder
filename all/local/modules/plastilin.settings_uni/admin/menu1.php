...
function OnBuildGlobalMenuHandlerNext(&$arGlobalMenu, &$arModuleMenu){
	if(!defined('PLASTILIN_MENU_INCLUDED'))
	{
		define('PLASTILIN_MENU_INCLUDED', true);
		...
		if($GLOBALS['APPLICATION']->GetGroupRight($moduleID) >= 'R'){
			...
			$arMenu = array(
				'menu_id' => 'global_menu_plastilin',
				'text' => Loc::getMessage("FIRST_MENU_NAME"),
				'title' => Loc::getMessage("FIRST_MENU_TITLE"),
				'sort' => 1000,
				'items_id' => 'global_menu_plastilin_items',
				'icon' => '',
				'items' => array(
					array(
						'text' => Loc::getMessage("OTHER_MENU_NAME"),
						'title' => Loc::getMessage("OTHER_MENU_TITLE"),
						'sort' => 10,
						'url' => '/bitrix/admin/'.$moduleID.'_main_setting.php',
						'icon' => 'util_menu_icon',
			...
			if(!isset($arGlobalMenu['global_menu_plastilin'])){
				$arGlobalMenu['global_menu_plastilin'] = array(
					'menu_id' => 'global_menu_plastilin',
					'text' => Loc::getMessage("MAIN_MENU_NAME"),
			...
			$arGlobalMenu['global_menu_plastilin']['items'][$moduleID] = $arMenu;
		}
	}
}
?>