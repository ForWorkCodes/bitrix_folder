...
$tab1 = [
  ...
  "OPTIONS" => array(
      ...
      array(
          "link_full_catalog",
          Loc::getMessage("link_full_catalog"),
          '',
          array("text")
      ),
      array(
...
$tab2 = [
    ...
    "OPTIONS" => array(
        ...
        array(
            "iblock_main_block_best_w",
            Loc::getMessage("OPTIONS_MAIN_BLOCK_BEST_W"),
            '825',
            array("selectbox", $arListCatalogSections)
        ),
        array(
            "iblock_main_block_best_m",
            Loc::getMessage("OPTIONS_MAIN_BLOCK_BEST_M"),
            '934',
            array("selectbox", $arListCatalogSections)
        ),
        array(
...
$tab7 = [
  ...
  "OPTIONS" => array(
    ...
    array(
      "link_men_image",
      Loc::getMessage("LINK_MEN_IMAGE"),
      '/local/templates/.default/img/Icons/avatar_boy.svg',
      array("text")
    ),
    array(
      "link_women_image",
      Loc::getMessage("LINK_WOMEN_IMAGE"),
      '/local/templates/.default/img/Icons/avatar_girl.svg',
      array("text")
    ),
    Loc::getMessage("PRICE_SETTINGS"),
    array(
...
<form action="<? echo($APPLICATION->GetCurPage()); ?>?mid=<? echo($module_id); ?>&lang=<? echo(LANG); ?>" method="post">
  ...
  <?
   foreach($aTabs as $aTab){
      ...
      if ($aTab['DIV'] == 'main_pages_tab')
      {
        ?>
        <tr>
          <td width="50%" class="adm-detail-content-cell-l"><br></td>
          <td width="50%" class="adm-detail-content-cell-r">
            <a href="/short-catalog/" target="_blank">Ссылка на редактирование короткого каталога</a>
          </td>
        </tr>
        <?
      }
