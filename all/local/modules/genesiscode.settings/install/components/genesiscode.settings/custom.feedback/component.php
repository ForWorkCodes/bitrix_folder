    ...
    if (check_bitrix_sessid()) {
        if (empty($arParams["REQUIRED_FIELDS"]) || !in_array("NONE", $arParams["REQUIRED_FIELDS"])) {
            ...
            if ((empty($arParams["REQUIRED_FIELDS"]) || in_array("PHONE",
                        $arParams["REQUIRED_FIELDS"])) && strlen($_POST["user_phone"]) <= 3) {
            ...
            if ((empty($arParams["REQUIRED_FIELDS"]) || in_array("CART",
                        $arParams["REQUIRED_FIELDS"])) && strlen($_POST["cart"]) < 1) {
                $arResult["ERROR_MESSAGE"][] = 'cart';
            }
        }
